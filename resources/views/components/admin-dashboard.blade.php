...
<head>
    ...
    <!-- Scripts -->
    <!-- StyleSheets  -->
    <link rel="stylesheet" href="{{ asset('assets/assets/css/dashlite.css?ver=2.8.0') }}">
    <link id="skin-default" rel="stylesheet" href="{{ asset('assets/assets/css/theme.css?ver=2.8.0') }}">
...
<script src="{{ asset('assets/js/libs/datatable-btns.js?ver=2.8.0') }}"></script>
