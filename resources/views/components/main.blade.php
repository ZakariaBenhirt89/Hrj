                        ...
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des text-soft">
                                    <p>Welcome to Sarp Dashboard Template.</p>
                                </div>
                                            ...
                                            <div class="card-inner">
                                                ...
                                                <div class="align-end gy-3 gx-5 flex-wrap flex-md-nowrap flex-lg-wrap flex-xxl-nowrap">
                                                    ...
                                                    <div class="nk-sales-ck sales-revenue"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                                        <canvas class="sales-bar-chart chartjs-render-monitor" id="salesRevenue" style="display: block; width: 431px; height: 148px;" width="431" height="148"></canvas>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card-inner">
                                                        ...
                                                        <div class="align-end flex-sm-wrap g-4 flex-md-nowrap">
                                                            ...
                                                            <div class="nk-sales-ck"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                                                <canvas class="sales-bar-chart chartjs-render-monitor" id="activeSubscription" width="266" height="56" style="display: block; width: 266px; height: 56px;"></canvas>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- .card -->
                                                ...
                                                <div class="card card-bordered">
                                                    <div class="card-inner">
                                                        ...
                                                        <div class="align-end flex-sm-wrap g-4 flex-md-nowrap">
                                                            ...
                                                            <div class="nk-sales-ck"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                                                <canvas class="sales-bar-chart chartjs-render-monitor" id="totalSubscription" width="273" height="56" style="display: block; width: 273px; height: 56px;"></canvas>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- .card -->
                                ...
                                <div class="card card-bordered h-100">
                                    <div class="card-inner">
                                        ...
                                        <div class="nk-sales-ck large pt-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                            <canvas class="sales-overview-chart chartjs-render-monitor" id="salesOverview" width="939" height="176" style="display: block; width: 939px; height: 176px;"></canvas>
                                        </div>
                                    </div>
                                </div><!-- .card -->
                            </div><!-- .col -->
