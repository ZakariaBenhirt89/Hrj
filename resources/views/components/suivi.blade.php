            ...
            <div class="content-body">
                <section id="basic-datatable">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <h1 class="coip-title">Susceptibilité Suivi</h1>
                                        ...
                                        @foreach( $forms as $form)
                                            <tr>
                                                ...
                                                @foreach( $form->fields()->where('type' , 'nation')->get() as $f)
                                                    <td>{{ $f->data }}</td>
                                                @endforeach
                                                <td><div class="d-inline-flex"><a class="pe-1 dropdown-toggle hide-arrow text-primary" data-bs-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical font-small-4"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg></a><div class="dropdown-menu dropdown-menu-end"><a href="{{ route('admin.user.suivi' , ['id' => $form->id]) }}" class="dropdown-item"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text me-50 font-small-4"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>Suivi</a></div></div></td>
                                            </tr>
                            ...
                            <div class="card">
                                ...
                                <table id="example1" class="display nowrap" style="width:100%">
                                    ...
                                    @isset( $suivi )
                                        ...
                                        @foreach( $suivi as $form)
                                            <tr>
                                                        <td>{{$form->fields()->where('type' , 'nom')->first()->data }} &nbsp; {{ $form->fields()->where('type' , 'prenom')->first()->data }}</td>
                                                <td>{{ Auth::user()->center }}</td>
                                                    <td>{{$form->fields()->where('type' , 'sex')->first()->data }}</td>

                                                    <td>{{ $form->fields()->where('type' , 'age')->first()->data }}</td>

                                                <td>{{ (new DateTime($form->created_at))->format('Y-m-d') }}</td>
                                                    <td>{{ $form->fields()->where('type' , 'nation')->first()->data }}</td>

                                                <td><span class="badge badge-glow bg-info">Suivi</span></td>
                                            </tr>
